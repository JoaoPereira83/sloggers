...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Southam Sloggers is a friendly Sunday cycling group based in Southam, Warwickshire. Rolling roads, good pace, and a proper coffee-and-cake stop. Come and ride with us." },
      { property: "og:title", content: "Southam Sloggers — Sunday Cycling Club, Warwickshire" },
      { property: "og:description", content: "Southam Sloggers is a friendly Sunday cycling group based in Southam, Warwickshire. Rolling roads, good pace, and a proper coffee-and-cake stop. Come and ride with us." },
